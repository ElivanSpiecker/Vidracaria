    ...
    <div class="bg-gray-900 text-white p-8">
        ...
        <form class="max-w-md mx-auto" id="update-form" method="POST" action="{{ route('admin.update', $conta->id) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nome" id="nome" required value="{{ $conta->nome }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 bg-gray-800 text-white">
            </div>
            <div class="mb-4">
                <label for="type" class="block text-sm font-semibold mb-2">Tipo:</label>
                <input type="text" name="type" id="type" required value="{{ $conta->type }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 bg-gray-800 text-white">
            </div>
            <div class="mb-4">
